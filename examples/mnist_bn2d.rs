...
use rstorch::nn::batchnorm2d::BatchNorm2d;
...
fn bn2d(channels: usize) -> BatchNorm2d {
    BatchNorm2d {
        gamma: Tensor::new(vec![1.0; channels], vec![channels]),
        beta: Tensor::new(vec![0.0; channels], vec![channels]),
        epsilon: 1e-5,
